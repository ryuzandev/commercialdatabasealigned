        ...
        <Col xs={12} md={6} lg={6} xl={6}>
          ...
          >
            <iframe
              width="1431"
              height="586"
              src="https://www.youtube.com/embed/fn9sZMBlYUY"
              title="32 QLED Onida TV"
              frameborder="0"
        ...
        <Col xs={12} md={6} lg={6} xl={6}>
          ...
          >
            <iframe
              width="1307"
              height="735"
              src="https://www.youtube.com/embed/WQOO1qE4V9A"
              title="Onida&#39;s Fabric Care S80GSB Bristle Wash Semi-Automatic Washing Machine"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              referrerpolicy="strict-origin-when-cross-origin"
              allowfullscreen
        ...
        <Col xs={12} md={6} lg={6} xl={6}>
          ...
          >
            <iframe
              width="1307"
              height="735"
              src="https://www.youtube.com/embed/rx9UqPYZ8fA"
              title="Onida 23 L Black Beauty Neo Convection Microwave Oven"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              referrerpolicy="strict-origin-when-cross-origin"
              allowfullscreen
