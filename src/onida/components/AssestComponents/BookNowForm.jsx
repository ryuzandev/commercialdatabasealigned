...
function BookNowForm({ onClose }) {
  ...
  const handleInputChange = (e) => {
    ...
    setFormData((prevData) => ({
      ...prevData,
      [name]: value,
      ...(name === "service" ? { companyMake: "ONIDA" } : {}), // Reset companyMake when service changes
    }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // await postData("onidaelectronics", formData);
      await postData("onidaelectronics", updatedFormData);
