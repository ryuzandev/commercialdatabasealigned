...
function BookNowCards() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const data = await getData("samsungelectronics"); // Replace 'bookings' with the name of your collection
      setBookData(data);
    };
          ...
          <div className="booknow-card" key={index}>
            ...
            <div className="booknow-card-actions">
              ...
              <button
                className="delete"
                onClick={() => {
                  deleteData("samsungelectronics", item.id);
                }}
              >
                Delete
              </button>
