...
function ExoticAutoDeleteCards() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const result = await getData("ifbelectronicsForward");
      // console.log(result);
      setData(result);
    };
    fetchData();
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      ...
      data.forEach((item, index) => {
        ...
        if (autoDelete) {
          deleteData("ifbelectronicsForward", item.id);
        }
      });
          ...
          <div className={styles.card} key={index}>
            ...
            <div className={styles.cardActions}>
              ...
              <button
                ...
                onClick={() => deleteData("ifbelectronicsForward", item.id)}
              >
                Delete
              </button>
            </div>
          ...
          <div className={styles.modalContent}>
            ...
            <div className={styles.modalActions}>
              ...
              <button
                className={styles.deleteBtn}
                onClick={() => {
                  deleteData("ifbelectronicsForward", selectedItem.id);
                  handleCloseModal();
                }}
              >
                Delete
